...
import { Smartphone, Layers, Layout, Zap, ShieldCheck, ArrowRight, Sparkles, Rocket, Code2 } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Custom iPhone and iPad applications built with Swift and Objective-C. We deliver sleek, high-performance apps tailored for the Apple ecosystem.",
    },
    {
      ...
      description: "Robust and scalable Android applications using Kotlin and Java. Reach millions of users with highly optimized, device-agnostic apps.",
    },
    {
      ...
      description: "Cost-effective, high-quality apps built with React Native and Flutter. Write once, deploy anywhere without compromising on native performance.",
    }
  ];

  const features = [
    { name: "Stunning UI/UX Design", icon: Layout },
    { name: "High Performance & Speed", icon: Zap },
    { name: "Enterprise-Grade Security", icon: ShieldCheck },
    { name: "Seamless API Integration", icon: Layers },
  ];
    ...
    <div className="min-h-screen bg-white pt-32 pb-20 px-6 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <section className="flex flex-col items-center justify-center text-center min-h-[60vh] mb-20 relative">
          ...
          >
            <Smartphone className="w-5 h-5 text-[#14A7B8]" />
          ...
          >
            Next-Generation <br className="hidden md:block" /> Mobile Applications
          </motion.h1>
          ...
          >
            Transform your business ideas into highly engaging native and cross-platform mobile experiences. We build scalable, secure, and user-centric apps for iOS and Android.
          </motion.p>
        ...
        >
          <div className="relative overflow-hidden inline-flex flex-col sm:flex-row items-center gap-6 p-8 md:p-10 bg-gradient-to-r from-gray-50 to-blue-50 rounded-3xl border border-blue-100 w-full max-w-4xl mx-auto justify-between shadow-lg shadow-blue-900/5">
            ...
            <div className="text-left relative z-10">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">Ready to build your next big app?</h3>
